...
class _ForgotPasswordEmailVerificationScreen extends StatefulWidget {
  const _ForgotPasswordEmailVerificationScreen();

  @override
  State<_ForgotPasswordEmailVerificationScreen> createState() => _ForgotPasswordEmailVerificationScreenState();
}

class _ForgotPasswordEmailVerificationScreenState extends State<_ForgotPasswordEmailVerificationScreen> with
