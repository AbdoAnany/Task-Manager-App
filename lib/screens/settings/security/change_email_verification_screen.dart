...
class ChangeEmailVerificationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: ChangeEmailVerificationScreen(),
    );
  }
}

class ChangeEmailVerificationScreen1 extends StatefulWidget {
  @override
  _ChangeEmailVerificationScreenState createState() => _ChangeEmailVerificationScreenState();
}

class _ChangeEmailVerificationScreenState extends State<ChangeEmailVerificationScreen1>
